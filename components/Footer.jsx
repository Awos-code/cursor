    ...
    <footer id="footer" className="pt-12 pb-6 bg-[#181826] text-center text-gray-400 text-sm border-t-0 relative">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between max-w-4xl mx-auto px-4 gap-4 relative z-10">
        ...
        <div className="flex gap-4 justify-center">
          <a href="https://discord.gg/GeyhxkME7e" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-fuchsia-400 transition text-2xl hover:scale-125 hover:drop-shadow-[0_0_16px_rgba(168,85,247,0.7)] interactive-element" title="Discord">
          ...
          <a href="https://github.com/Awos-code/cursor" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-fuchsia-400 transition text-2xl hover:scale-125 hover:drop-shadow-[0_0_16px_rgba(168,85,247,0.7)] interactive-element" title="GitHub">
        ...
        <div className="flex gap-4 justify-center mt-4">
          <a href="/privacy" className="text-fuchsia-400 hover:underline interactive-element">Privacy Policy</a>
          <a href="/terms" className="text-fuchsia-400 hover:underline interactive-element">Terms of Service</a>
        </div>
        <span className="text-gray-500 mt-2 block">{t('footer.copyright')}</span>
      </div>
    </footer>
  );
}
