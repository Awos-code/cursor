...
const translations = {
  ru: {
    ...
    inviteButton: "Пригласить бота",
    featuresButton: "Особенности"
  },
  en: {
...
export default function Hero({ locale = "ru" }) {
